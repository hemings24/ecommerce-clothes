                        ...
                        <div class="shop-product-fillter">
                            ...
                            <div class="sort-by-product-area">
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a href="{{$orderBy=='Default' ? 'active':''}}" wire:click.prevent="changeOrderBy('Default')">Default</a></li>
                                            ...
                                            <li><a href="{{$orderBy=='Most Recent' ? 'active':''}}" wire:click.prevent="changeOrderBy('Most Recent')">Most Recent</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
